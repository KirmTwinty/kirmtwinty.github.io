...
window.onload = function(){
    ...
    content = '';
	content+='<label class="select-label">Activité</label><select class="cs-select cs-skin-slide">';
...
function updateActivite(){
	...
	en = document.getElementById("activity");
	en.innerHTML = "Durée : " + total_duree + "kJ (" + kj_to_kcal(total_energie) + "kcal)";
	if(total_energie == 0)
		en.style.visibility = "hidden";
	else
		en.style.visibility = "visible";
